...
const emailContent = (verificationLink, email, name) => {
    return `
  <!DOCTYPE html>
  <html>
    <head>
          ...
          <td align="center" bgcolor="#e9ecef">
            ...
            >
              ...
              <tr>
                ...
                >
                  <p style="margin: 0">
                    To activate your Planify Account, please verify your email
                    address. Your account will not be created until your email
